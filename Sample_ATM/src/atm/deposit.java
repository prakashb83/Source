...
public class deposit extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
	        ...
	        double deposit_amt = Double.parseDouble(request.getParameter("deposit"));
	        ...
	        newBalance =  deposit_amt + currentBal;
            ...
            //out.println("<script>alert('Your Amount has been Deposited');</script>");
