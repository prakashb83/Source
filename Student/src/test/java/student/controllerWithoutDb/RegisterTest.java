package student.controllerWithoutDb;
...
import studentcontrollerWithoutDb.UserRegisterController;
...
public class RegisterTest extends Mockito{
    ...
    public void testRegistrationSuccess() throws Exception {
        ...
        when(request.getParameter("email")).thenReturn("Xsathyanjaneyulu.mamilla@wipro.com");
        when(request.getParameter("pass")).thenReturn("devops");
        when(request.getParameter("confirmpass")).thenReturn("devops");
    ...
    public void testRegistrationFail() throws Exception {
    	when(request.getParameter("firstname")).thenReturn("fname");
    	when(request.getParameter("lastname")).thenReturn("lname");
        when(request.getParameter("email")).thenReturn("sathyanjaneyulu.mamilla@wipro.com");
        when(request.getParameter("pass")).thenReturn("devops");
        when(request.getParameter("confirmpass")).thenReturn("devops@");
